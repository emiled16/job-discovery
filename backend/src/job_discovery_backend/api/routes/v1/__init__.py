...
from job_discovery_backend.api.routes.v1.admin import router as admin_router
from job_discovery_backend.api.routes.v1.applications import router as applications_router
from job_discovery_backend.api.routes.v1.companies import router as companies_router
